Per l'homework n.1 verrà usata la classe RemoveSubString contenente un metodo chiamato removeSubString che cerca una sottostringa all'interno di una stringa
